...
class UltraLightFaceDetecion:
    def __init__(
        ...
        self._min_boxes = np.array([[10, 16, 24], [32, 48], [64, 96], [128, 192, 256]])
        ...
        self._nms = partial(
            tf.image.non_max_suppression, max_output_size=nms_max_output_size, iou_threshold=nms_iou_threshold
        )
        ...
        self._get_scores_tensor = partial(self._interpreter.get_tensor, output_details[1]["index"])
